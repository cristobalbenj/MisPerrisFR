...
from django.urls import path
from django.contrib import admin
from core.views import menu,home,galeria,formulario,agregar_mascotas,listar_mascotas,eliminar_mascotas,modificar_mascota,agregar_adoptante,listar_adoptantes,eliminar_adoptante,modificar_adoptante
